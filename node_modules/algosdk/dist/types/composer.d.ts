import { ABIMethod, ABIValue } from './abi';
import Algodv2 from './client/v2/algod/algod';
import { SimulateResponse, SimulateRequest } from './client/v2/algod/models/types';
...
export declare class AtomicTransactionComposer {
     ...
     */
    simulate(client: Algodv2, request?: SimulateRequest): Promise<{
     ...
     */
    static parseMethodResponse(method: ABIMethod, methodResult: ABIResult, pendingInfo: Record<string, any>): ABIResult;
}
